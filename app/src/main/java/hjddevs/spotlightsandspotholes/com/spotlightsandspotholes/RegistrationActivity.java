...
public class RegistrationActivity extends AppCompatActivity{
    ...
    private EditText userName, userPassword, userEmail, userPincode;
    private Button regButton;
    private TextView userLogin;
    private FirebaseAuth firebaseAuth;
    private ImageView userProfilePic;
    String email, name, pincode, password;
 ...
 //   }
   ...
   //     });
    ...
    private void setupUIViews(){
        ...
        userPincode = (EditText)findViewById(R.id.etPincode);
    ...
    private Boolean validate(){
        ...
        if (!"370001".equals(pincode)) {
            Toast.makeText(getApplicationContext(), "non sevicable pin", Toast.LENGTH_SHORT).show();
            return result;
        }
    //   if(imagePath == null){
  ...
  //          }
  //      });
        UserProfile userProfile = new UserProfile(pincode, email, name);
